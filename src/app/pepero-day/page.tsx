...
export default function Page() {
    return (
        <main className="relative w-full min-h-screen py-20 px-6 bg-white text-black flex flex-col md:flex-row">
            {/* Left Column */}
            ...
            <section className="flex-1 border border-blue-400">
                ...
                <div className="relative">
                    <h3 className="absolute top-0 w-full">Content Coordination</h3>
                    <p className="flex justify-between">
            ...
            {/* Right Column */}
            <div className="md:w-96 border border-green-400">
