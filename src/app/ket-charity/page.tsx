...
export default function KetCharityPage() {
  return (
    <ProjectPageLayout
      title='"Ket" A charity trip'
      subtitle="[PHOTO DOCUMENTARY]"
      musicStaffLeft="Largo"
      musicStaffRight="Apr 2025"
      musicStaffBpm={44}
    >
      {/* Main image */}
      <div>
        <p>
          “Ket” means an ending to a story, or a bond between us. Either meaning
          represents RMIT Cineverse Club--a space for cinephiles. Together, we
          take on a trip to document the lives of orphans and teach them how to
      ...
      <p className="pt-12 lg:pt-24">
        Upon arrival, the kids were suspicious and distant. Yet they lit up over
        the littlest toys--the kind we had long left in the corner of our
        memories.
      </p>
      ...
      <p className="pt-12 lg:pt-24">
        ...
        memories each name are slowly fading. After a lifetime devoted to care,
        the future before these respected caregivers remains uncertain.
      </p>
      <Image
